...
PAGINE = [
{
 ...
 'title': 'Calcolo fabbisogno calorico giornaliero (TDEE) e metabolismo basale',
 'og_title': 'Calcolo del fabbisogno calorico giornaliero',
 'description': 'Calcola il fabbisogno calorico giornaliero e il metabolismo basale da età, peso, altezza, sesso e attività, con la formula Mifflin-St Jeor. Gratis, senza registrazione, il risultato resta nel tuo browser.',
...
},
{
 ...
 'description': 'Calcola il deficit calorico dai tuoi dati e scopri quante calorie mangiare per dimagrire, con la perdita di peso attesa a settimana. Perché il target non deve mai scendere sotto il metabolismo basale.',
...
},
{
 ...
 'title': 'Calcolo macronutrienti: proteine, grassi e carboidrati in grammi',
 'og_title': 'Calcolo dei macronutrienti',
 'description': 'Calcola proteine, grassi e carboidrati in grammi partendo dalle tue calorie e dal tuo peso. Perché proteine e grassi hanno un pavimento e i carboidrati sono il macro che si muove.',
...
},
{
 ...
 'title': 'Scheda definizione: come strutturare l\'allenamento in deficit',
 'og_title': 'Scheda per la definizione muscolare',
 'description': 'Come si costruisce una scheda di definizione: volume concentrato su due distretti, carichi difesi, cinque sedute a settimana. Con il generatore che la scrive sui tuoi dati, gratis e senza account.',
